...
#include "tflite-model/tflite_learn_84.h"
#include "edge-impulse-sdk/classifier/ei_model_types.h"
#include "edge-impulse-sdk/classifier/inferencing_engines/engines.h"

const char* ei_classifier_inferencing_categories[] = { "level_0", "level_1", "level_2", "level_3" };

EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_83_axes[] = { 0 };
const uint32_t ei_dsp_config_83_axes_size = 1;
ei_dsp_config_image_t ei_dsp_config_83 = {
    83, // uint32_t blockId
...
ei_model_dsp_t ei_dsp_blocks[ei_dsp_blocks_size] = {
    { // DSP block 83
        ...
        (void*)&ei_dsp_config_83, // pointer to config struct
        ei_dsp_config_83_axes, // array of offsets into the input stream, one for each axis
        ei_dsp_config_83_axes_size, // number of axes
        1, // version
        nullptr, // factory function
        nullptr, // data normalization config
    }
};
const ei_config_tflite_graph_t ei_config_tflite_graph_84 = {
    .implementation_version = 1,
    .model = tflite_learn_84,
    .model_size = tflite_learn_84_len,
    .arena_size = tflite_learn_84_arena_size
};

ei_learning_block_config_tflite_graph_t ei_learning_block_config_84 = {
    .implementation_version = 1,
    ...
    .quantized = 1,
    .compiled = 0,
    .graph_config = (void*)&ei_config_tflite_graph_84
};

const uint8_t ei_learning_blocks_size = 1;
const uint32_t ei_learning_block_84_inputs[1] = { 83 };
const uint8_t ei_learning_block_84_inputs_size = 1;
const ei_learning_block_t ei_learning_blocks[ei_learning_blocks_size] = {
    {
        84,
        false,
        &run_nn_inference,
        (void*)&ei_learning_block_config_84,
        EI_CLASSIFIER_IMAGE_SCALING_0_255,
        ei_learning_block_84_inputs,
        ei_learning_block_84_inputs_size,
        4
    },
};
